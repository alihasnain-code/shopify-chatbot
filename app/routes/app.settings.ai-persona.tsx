...
export const action = async ({ request }: ActionFunctionArgs) => {
    ...
    const customInstructions = (formData.get("customInstructions") as string | null)?.trim() || null;
...
export default function AiPersona() {
    ...
    const policiesStatus = settings.policiesStatus as keyof typeof STATUS_BADGE;
    ...
    useEffect(() => {
        const saveBar = document.getElementById("ai-persona-save-bar") as any;
        if (!saveBar) return;
        ...
        <form onSubmit={handleSave}>
            ...
            <s-section heading="AI Persona & Custom Instructions">
                <s-text-area
                    ...
                    onInput={(e: any) => setFormState({ ...formState, customInstructions: e.currentTarget.value })}
                ></s-text-area>
                <s-select
                    label="AI Tone of Voice"
                    details="Controls the emotional delivery and style of responses generated by the AI."
                    value={formState.tone}
                    onChange={(e: any) => setFormState({ ...formState, tone: e.currentTarget.value })}
                >
